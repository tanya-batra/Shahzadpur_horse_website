...
{{-- Header Section End --}}
    ...
    <div class="container py-5">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center" data-aos="fade-down">
          <h1 class="display-4 playfair-title text-gold mb-3 text-shadow">Where Passion Meets Breeding</h1>
          <p class="lead mb-4 text-white-50">At Shahjadpur stables, we preserve Marwari horses — Rajasthan’s valor & Punjab’s equine tradition.</p>
          <a href="#about" class="btn btn-gold btn-lg px-5">Discover More <i class="bi bi-arrow-right ms-2"></i></a>
        </div>
      </div>
    </div>
  </section>
  ...
  <main class="py-5" id="about">
    <div class="container">
      <h1 class="section-title" data-aos="fade-up" data-i18n="about.title">About Us</h1>
      <p class="lead mb-5" data-aos="fade-up" data-i18n="about.lead">
        At Shahjadpur stables, we are committed to preserving the rare and regal Marwari horse — a symbol of Rajasthan’s valor and Punjab’s enduring connection with equine excellence.
      </p>
      <div class="row g-4 mt-2">
        <div class="col-12 col-lg-6" data-aos="fade-right">
          <div class="card p-4 h-100">
            <h3 class="playfair-title text-maroon mb-3 border-gold pb-2" data-i18n="about.storyTitle">Our Story</h3>
            <p data-i18n="about.story">
              Founded with passion in the heart of Punjab, our stud farm draws inspiration from centuries-old traditions where horses were not just animals, but loyal companions in war and peace. Our journey began with a single vision — to revive and promote the pure Marwari bloodline with dignity, dedication, and discipline.
            </p>
          </div>
        </div>
        <div class="col-12 col-lg-6" data-aos="fade-left">
          <div class="card p-4 h-100">
            <h3 class="playfair-title text-maroon mb-3 border-gold pb-2" data-i18n="about.missionTitle">Our Mission</h3>
            <p data-i18n="about.mission">
              To breed, train, and care for Marwari horses in a way that blends ancient wisdom with modern standards. We uphold ethical breeding practices, complete transparency, and international health protocols to ensure every foal born here represents the finest of the Marwari lineage.
            </p>
          </div>
        </div>
        <div class="col-12 col-lg-6" data-aos="fade-right">
          <div class="card p-4 h-100">
            <h3 class="playfair-title text-maroon mb-3 border-gold pb-2" data-i18n="about.heritageTitle">Heritage & Inspiration</h3>
            <p data-i18n="about.heritage">
              Our farm honors the warrior spirit of Sikh history and the deep-rooted connection of Punjabi soil with majestic horses. Guided by the legacy of Baba Deep Singh Ji and the courage of past generations, our stables are more than a business — they are a tribute to tradition and bravery.
            </p>
          </div>
        </div>
        <div class="col-12 col-lg-6" data-aos="fade-left">
          <div class="card p-4 h-100">
            <h3 class="playfair-title text-maroon mb-3 border-gold pb-2" data-i18n="about.visionTitle">A Global Vision</h3>
            <p data-i18n="about.vision">
              While rooted in Indian heritage, our outlook is global. We aim to showcase Marwari horses on the international stage — from exhibitions and cultural events to global equine networks. Every step we take is to place the Marwari breed where it rightfully belongs: on the world map of elite horse breeding.
            </p>
          </div>
        </div>
      </div>
