...
{{-- Header Section End --}}
    ...
    <main class="py-5">
      <div class="container">
        <h1 class="section-title mb-3">Gallery Categories</h1>
       <div class="row g-3">
  @foreach ($categories as $category)
    <div class="col-12 col-md-4">
      <div class="card shadow-sm h-100">
        <div class="ratio ratio-4x3">
          <img src="{{ asset($category->thumbnail) }}" class="gallery-img" alt="{{ $category->name }}">

        </div>
        <div class="card-body text-center">
          <h6 class="card-title" style="font-style: italic; color: #800000;">
            <a href="{{ route('gallery.images', $category->id) }}" class="text-decoration-none" style="color: #800000; font-weight: 600;">
              {{ $category->name }}
            </a>
          </h6>
        </div>
