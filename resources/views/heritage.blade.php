  ...
  100% {
   ...
   body { background: #f7f5ef; }
    ...
    .social-icons i { font-size: 1.3rem; }
        body { background: #f7f5ef; }
    .bg-maroon { background: #2c001e!important; }
    .text-gold { color: #cfa137!important; }
    .playfair-title { font-family: 'Playfair Display', serif; letter-spacing:.03em; text-transform:uppercase;}
    .section-title {
      font-size:2.8rem; font-family:'Playfair Display',serif; color:#2c001e; letter-spacing:2px; font-weight:700;
      border-left:6px solid #cfa137; padding-left:18px; margin-bottom:32px;
    }
    .hero-banner {
      min-height: 60vh;
      position: relative;
      background: linear-gradient(125deg,#2c001e 70%,#cfa137 100%);
      color: #fff;
      display: flex; align-items: center;
      overflow: hidden;
      box-shadow: 0 8px 32px rgba(82,27,42,0.16);
    }
    .hero-banner .hero-bg-img {
      ...
      opacity: .23; z-index:1;
    }
    .hero-banner .container { position: relative; z-index:2; }
    .hero-banner-title {
      font-size:2.8rem; font-family:'Playfair Display',serif; font-weight:700; letter-spacing:1.5px;
      margin-bottom: 1.1em; color: #cfa137; text-shadow:0 4px 22px #2c001e88;
    }
    .hero-banner-lead {
      font-size:1.25rem; color: #fff; opacity:.93;
      background:border-radius:22px; padding: .71em 2.9em;
      display: inline-block; box-shadow: 0 1.2px 8px rgba(44,0,30,.09);
    }
    .timeline-section { background: #fff; }
    .timeline-card {
      background: #f7f5ef;
      border-radius:1.1rem;
      box-shadow: 0 4px 18px rgba(82,27,42,0.06);
    ...
    .timeline-card img {
      border-radius:.8rem;
      box-shadow: 0 2px 18px rgba(80,20,40,.08);
    ...
    @media (max-width:768px){
      .hero-banner-title{ font-size:2.02rem;}
      .section-title{ font-size:2.02rem;}
      .timeline-card{ padding:1.2rem .7rem;}
    }
    @media (max-width:576px){
      .hero-banner-title{ font-size:1.34rem;}
...
{{-- Header Section End --}}
  <!-- Hero Banner  -->
  <section class="hero-banner text-center py-5 d-flex">
    <div class="hero-bg-img"></div>
    <div class="container my-auto">
      <h1 class="hero-banner-title mb-3 playfair-title" data-aos="fade-down">Punjabi & Sikh Heritage</h1>
      <p class="hero-banner-lead" data-aos="fade-up">The timeless bond of Punjab and horses — courage, dignity, and devotion.</p>
    </div>
  </section>
...
<section class="timeline-section py-5">
    <div class="container">
        @foreach($heritageSubcategories as $subcategory)
            <div class="row align-items-center mb-5 {{ $loop->iteration % 2 == 0 ? 'flex-md-row-reverse' : '' }}">
                ...
                <!-- Text -->
                <div class="col-md-6" data-aos="{{ $loop->iteration % 2 == 0 ? 'fade-right' : 'fade-left' }}">
                    <div class="timeline-card">
                        <h3 class="playfair-title">{{ $subcategory->name }}</h3>
