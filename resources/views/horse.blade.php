  ...
  <main class="py-5">
    <div class="container">
      ...
      <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3 mb-4">
        <h1 class="section-title m-0" data-i18n="horses.title">Horses</h1>
        <div class="d-flex gap-2 flex-wrap">
          <a class="btn btn-outline-dark btn-sm" href="#for-sale" data-i18n="horses.filter.sale">For Sale</a>
<a class="btn btn-outline-dark btn-sm" href="#breeding" data-i18n="horses.filter.stallions">Breeding Stallions</a>

        </div>
      </div>

   <h2 id="for-sale" class="fs-4 mt-4 mb-3">{{ $category->name ?? 'For Sale' }}</h2>

<div class="row g-4 mb-5">
    @forelse ($category->subcategories as $horse)
        <div class="col-12 col-md-6 col-xl-3">
            <div class="card horse-card h-100">
                <img src="{{ asset( $horse->image) }}" alt="{{ $horse->name }}" class="card-img-top horse-img" />
                <div class="card-body">
                    <h5 class="card-title">{{ $horse->name }}</h5>
                    <p class="card-text small">{{ Str::limit($horse->short_description, 80) }}</p>
                    <div class="d-flex gap-2 justify-content-center">
                        <button class="btn btn-gold btn-sm" data-bs-toggle="modal" data-bs-target="#enquireModal" data-horse="{{ $horse->name }}">Enquire</button>
                        <a href="#" class="btn btn-outline-gold btn-sm">Details</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    @endforelse
     ...
     <!-- Breeding Stallions -->
<h2 id="breeding" class="fs-4 mt-4 mb-4" data-i18n="horses.breeding">Breeding Stallions</h2>

<div class="row g-4 mb-3 mt-2">
    @forelse ($breedingSubcategories as $stallion)
        <div class="col-12 col-md-6 col-xl-6">
            <div class="card horse-card h-100">
                <img src="{{ asset( $stallion->image) }}" alt="{{ $stallion->name }}" class="card-img-top horse-img" />
                <div class="card-body">
                    <h5 class="card-title">{{ $stallion->name }}</h5>
                    <p class="card-text small">{{ Str::limit($stallion->short_description, 120) }}</p>
                    <div class="d-flex gap-2 justify-content-center">
                        <button class="btn btn-gold btn-sm" data-bs-toggle="modal" data-bs-target="#enquireModal" data-horse="{{ $stallion->name }}">Enquire</button>
                        <a href="#" class="btn btn-outline-gold btn-sm">Details</a>
                    </div>
                </div>
            </div>
    ...
    @empty
        <p>No breeding stallions available at this time.</p>
    @endforelse
</div>
